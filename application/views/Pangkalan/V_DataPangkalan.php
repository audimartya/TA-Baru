                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <div align="right">
                                   <form action="<?php echo site_url(); echo "Pangkalan/C_Pangkalan/index/"; ?>" method=post>
                          ...
                          <div class="content table-responsive table-full">
                                <table width="101%" class="table table-hover table-striped">
                                  ...
                                  <th width="3%">ID Member</th>
                                    ...
                                    <td width="1%"></thead>
                                    <tbody>
                                        <?php foreach ($C_Pangkalan as $key) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<?php echo site_url(); echo "/Pangkalan/C_Pangkalan/editPangkalan/"; echo $key['id_member'];?>" method=post>
